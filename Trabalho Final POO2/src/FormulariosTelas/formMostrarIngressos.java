 ...
 * @author zebodexx
 */
public class formMostrarIngressos extends javax.swing.JFrame {
    ...
    public formMostrarIngressos(ArrayList<Evento> eventosLista) {
        initComponents();
    ...
    public void carregarTableIngressoDisponiveis() {
        for (int i = 0; i < eventosListaMostrar.size(); i++) {
            ...
            System.out.println(txtIngressos);
        }
    ...
    private void initComponents() {
        ...
        setTitle("MOSTRAR INGRESSOS DISPONIVEIS");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formMostrarIngressos().setVisible(true);
            }
        });
    }
